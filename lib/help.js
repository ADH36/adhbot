...
function help(prefix, pushname) {
    return `👋️Hi ${pushname}, I'm ${botname} by A.D.H!

Prefix - ${prefix}

For help and support Join Support Group - https://chat.whatsapp.com/ILR4zpKwN1z8Rllmgm72eT
...
*_CMD: ${prefix}slap @user_*
*Description: Slaps the mentioned user*

*_CMD: ${prefix}punch @user_*
*Description: Punchs the mentioned user*

*_CMD: ${prefix}headpat @user_*
*Description: headpats the mentioned user*

*_CMD: ${prefix}matchme @user_*
*Description: Matches you with your perfect match*
